...
13n + 2 \in O(2n^2+n)
$$
![BigOExample](Media\asymptoticAnalysis\BigOExample.svg)
...
11n+1 \in O(2n+4)
$$
![BigOExample2](Media\asymptoticAnalysis\BigOExample2.svg)
...
![BigOExample3](Media\asymptoticAnalysis\BigOExample3.svg)
...
![BigOmegaExample1](Media\asymptoticAnalysis\BigOmegaExample.svg)
...
![BigTheta](Media/asymptoticAnalysis/BigThetaExample.svg)
...
![Bubble Sort vs Merge Sort Mean Running times from size 0 to size 100](Media/asymptoticAnalysis/RunningTimeExperiment.png)
...
![Bubble Sort vs Merge Sort Running Time Instruction Approximation Plot](Media/asymptoticAnalysis/RunningTimeApproximate.png)
